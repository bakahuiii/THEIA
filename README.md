...
> THEIA v0.6.3 是面向北京化工大学学生的本地优先 Windows 校园工作台。
...
[下载 Windows x64 v0.6.3](https://github.com/bakahuiii/THEIA/releases/tag/v0.6.3) · [Android 客户端](https://github.com/bakahuiii/THEIA-Android) · [用户指南](docs/guides/USER_GUIDE.md) · [发行说明](docs/releases/v0.6.3.md)
...
1. 从 [v0.6.3 Release](https://github.com/bakahuiii/THEIA/releases/tag/v0.6.3) 下载并安装 Windows x64 安装包。
...
npm run dist:installer          # 构建、验证并自动发布 GitHub Release
npm run dist:source
```
...
v0.6.3 的 Windows 安装包当前未配置可公开验证的 Authenticode 证书，Windows 可能显示未知发布者或 SmartScreen 提示。正式发布产物与 SHA-256 校验值会随发布流程生成，详见 [v0.6.3 发行说明](docs/releases/v0.6.3.md)。
