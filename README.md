...
> THEIA v0.6.1 是面向北京化工大学学生的本地优先 Windows 校园工作台。
...
[下载 Windows x64 v0.6.1](https://github.com/bakahuiii/THEIA/releases/tag/v0.6.1) · [用户指南](docs/guides/USER_GUIDE.md) · [发行说明](docs/releases/v0.6.1.md)
...
1. 从 [v0.6.1 Release](https://github.com/bakahuiii/THEIA/releases/tag/v0.6.1) 下载并安装 Windows x64 安装包。
