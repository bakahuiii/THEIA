...
import {
  MOTION_BASE_URL,
  MOTION_VENUE_LIMIT,
  MOTION_VENUE_PARSER_VERSION,
  motionCampus,
  motionStatusKey,
  motionVenueText,
  normalizeMotionStatus as motionStatus,
  normalizeMotionVenue as motionVenue,
} from './motion-venue-catalog.mjs'

export { MOTION_VENUE_PARSER_VERSION } from './motion-venue-catalog.mjs'
